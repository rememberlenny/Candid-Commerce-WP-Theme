<div class="wrap woocommerce">
    ...
    <h2><?php _e( 'Global Add-ons', 'wc_product_addons' ) ?> <a href="<?php echo add_query_arg( 'add', true ); ?>" class="add-new-h2"><?php _e( 'Add Global Add-on', 'wc_product_addons' ); ?></a></h2><br/>
				...
				if ( $global_addons ) {
					foreach ( $global_addons as $global_addon ) {
						...
						<tr>
							...
							?></td>
							<td>
								<a href="<?php echo add_query_arg( 'edit', $global_addon->ID ); ?>" class="button"><?php _e( 'Edit', 'wc_product_addons' ); ?></a> <a href="<?php echo wp_nonce_url( add_query_arg( 'delete', $global_addon->ID ), 'delete_addon' ); ?>" class="button"><?php _e( 'Delete', 'wc_product_addons' ); ?></a>
							</td>
						</tr>
						<?php
					}
					...
					?>
					<tr>
						<td colspan="5"><?php _e( 'No global add-ons exists yet.', 'wc_product_addons' ); ?> <a href="<?php echo add_query_arg( 'add', true ); ?>"><?php _e( 'Add one?', 'wc_product_addons' ); ?></a></td>
					</tr>
					<?php
				}
			?>
